...
function preload(){
  ...
  backImg = loadImage("ninja back.jpg");
...
function setup() {
  ...
  ninjaback1 = createSprite(300,300,10,10)
  ninjaback1.addImage(backImg);
  ninjaback1.scale = 0.8;
  ...
  knife.setCollider("rectangle",0,0,40,50);
